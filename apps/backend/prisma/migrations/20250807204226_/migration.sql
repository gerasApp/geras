...
INSERT INTO "new_assets" ("createdAt", "description", "historicalReturn", "id", "name", "planId", "risk", "type", "updatedAt", "userId") SELECT "createdAt", "description", "historicalReturn", "id", "name", "planId", "risk", "type", "updatedAt", "userId" FROM "assets";
DROP TABLE "assets";
