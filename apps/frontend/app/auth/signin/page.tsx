...
export default function SignInPage() {
  ...
  const handleSignIn = async (providerId: string) => {
    ...
    try {
      await signIn(providerId, { callbackUrl: "/inicio" });
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-helvetica-bold text-[var(--color-brand-primary)] mb-2">
            Bienvenido a Geras
          </h1>
          <p className="text-[var(--color-brand-dark)] font-helvetica-regular">
          ...
          <div className="space-y-3">
            {providers && providers.google && (
              ...
              >
                ...
                <span className="text-gray-700 font-helvetica-regular">
            ...
            {providers && providers.github && (
              ...
              >
                ...
                <span className="font-helvetica-regular">
