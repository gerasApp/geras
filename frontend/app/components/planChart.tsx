    ...
    <div className="bg-white rounded-xl shadow-lg p-6 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
          ...
          <p className="text-2xl font-bold text-blue-900">{formatCurrency(finalValues?.total || 0)}</p>
        </div>
        <div className="bg-green-50 rounded-lg p-4 border-l-4 border-green-500">
          <h3 className="text-sm font-medium text-green-800">Total Aportado</h3>
          <p className="text-2xl font-bold text-green-900">{formatCurrency(finalValues?.aportado || 0)}</p>
        </div>
        <div className="bg-amber-50 rounded-lg p-4 border-l-4 border-amber-500">
          <h3 className="text-sm font-medium text-amber-800">Intereses Ganados</h3>
          <p className="text-2xl font-bold text-amber-900">{formatCurrency(finalValues?.interes || 0)}</p>
        </div>
      </div>
